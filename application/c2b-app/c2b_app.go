...
func main() {
	...
	mowerID1 := "1111"
	// //mowerID2 := "12"
	// createCustomer(contract, customerID)
	// createMower(contract, customerID, mowerID1, 3.0, 5.0, 2.0)
	// readCustomer(contract, customerID)
	// //readSLA(contract2, mowerID1)
	// getCustomerSLAs(contract, customerID)
	// createMower(contract, customerID, mowerID2, 2.0, 3.0, 1.0)
	// readCustomer(contract, customerID)
	// getCustomerSLAs(contract, customerID)
	// removeMowerSLA(contract, customerID, mowerID2)
	// readCustomer(contract, customerID)
	getCustomerSLAs(contract, customerID)
	// createJob(contract2)
	updateGrassLengthInterval(contract, customerID, mowerID1, 4, 2)
	getCustomerSLAs(contract, customerID)
	updateTargetGrassLength(contract, customerID, mowerID1, 2.5)
	getCustomerSLAs(contract, customerID)
...
func createMower(contract *client.Contract, customerID string, mowerID string, targetgrasslength float32, maxgrasslength float32, mingrasslength float32) {
	...
	_, err := contract.SubmitTransaction("CreateMower", customerID, mowerID, targetgrasslength_string, maxgrasslength_string, mingrasslength_string)
...
func readSLA(contract *client.Contract, mowerID string) {
...
func readCustomer(contract *client.Contract, customerID string) {
